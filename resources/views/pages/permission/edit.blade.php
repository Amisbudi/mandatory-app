                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('permissions.index') }}"
                                class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Permissions</a>
                        </div>
                    </li>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('permissions.update', $permission->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ $permission->name }}" class="block"
                                placeholder="Permission" required>
                        </div>
                        <div>
                            <button type="submit"
                                class="bg-sky-500 hover:bg-sky-600 text-white text-sm rounded-lg py-2.5 px-4">Simpan
                                perubahan</button>
                        </div>
                    </form>
                </div>
